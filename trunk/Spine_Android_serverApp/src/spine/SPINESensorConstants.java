...
public class SPINESensorConstants {
	 ...
	 * 
	 * @param code
	 *            numeric code the sensor to convert into a human friendly label
	 * @return human friendly label of the given sensor code
	 */
	public static String sensorCodeToString(byte code) {
		switch (code) {
		case ACC_SENSOR:
			return ACC_SENSOR_LABEL;
		case VOLTAGE_SENSOR:
			return VOLTAGE_SENSOR_LABEL;
		case GYRO_SENSOR:
			return GYRO_SENSOR_LABEL;
		case INTERNAL_TEMPERATURE_SENSOR:
			return INTERNAL_TEMPERATURE_SENSOR_LABEL;
		case EIP_SENSOR:
			return EIP_SENSOR_LABEL;
		case ECG_SENSOR:
			return ECG_SENSOR_LABEL;
		case TEMPERATURE_SENSOR:
			return TEMPERATURE_SENSOR_LABEL;
	 ...
	 * 
	 * @param hasCh1
	 *            true if channel1 is enabled in this bitmask; false otherwise
	 * @param hasCh2
	 *            true if channel2 is enabled in this bitmask; false otherwise
	 * @param hasCh3
	 *            true if channel3 is enabled in this bitmask; false otherwise
	 * @param hasCh4
	 *            true if channel4 is enabled in this bitmask; false otherwise
	 * 
	 * @return the numeric code of the given channel bitmask
	 */
	public static byte getValueTypesCodeByBitmask(boolean hasCh1,
			boolean hasCh2, boolean hasCh3, boolean hasCh4) {
		byte code = 0;
	 ...
	 * 
	 * @param code
	 *            the numeric code of the given channel bitmask
	 * 
	...
	public static String channelBitmaskToString(byte code) {
		...
		case CH1_CH2_ONLY:
			return "ch1, ch2";
		case CH1_CH2_CH3_ONLY:
			return "ch1, ch2, ch3";
		case CH1_CH2_CH4_ONLY:
			return "ch1, ch2, ch4";
		case CH1_CH3_ONLY:
			return "ch1, ch3";
		case CH1_CH3_CH4_ONLY:
			return "ch1, ch3, ch4";
		case CH1_CH4_ONLY:
			return "ch1, ch4";
	...
	public static byte channelBitmaskByString(String label) {

		if (label.equals("ch1, ch2, ch3, ch4"))
			return ALL;
		if (label.equals("ch1, ch2, ch3"))
			return CH1_CH2_CH3_ONLY;
		if (label.equals("ch1, ch2, ch4"))
			return CH1_CH2_CH4_ONLY;
		if (label.equals("ch1, ch3, ch4"))
			return CH1_CH3_CH4_ONLY;
		if (label.equals("ch2, ch3, ch4"))
			return CH2_CH3_CH4_ONLY;
		if (label.equals("ch1, ch2"))
			return CH1_CH2_ONLY;
		if (label.equals("ch1, ch3"))
			return CH1_CH3_ONLY;
		if (label.equals("ch1, ch4"))
			return CH1_CH4_ONLY;
		if (label.equals("ch2, ch3"))
			return CH2_CH3_ONLY;
		if (label.equals("ch2, ch4"))
			return CH2_CH4_ONLY;
		if (label.equals("ch3, ch4"))
			return CH3_CH4_ONLY;
		if (label.equals("ch1"))
			return CH1;
		if (label.equals("ch2"))
	 ...
	 * 
	 * @param code
	 *            the numeric code of the given channel
	 * 
	 ...
	 * 
	 * @param code
	 *            the numeric code of the given time scale
	 * 
	 ...
	 * 
	 * @param label
	 *            the time scale label to be returned as its numeric code
	 * 
	 ...
	 * 
	 * @param chID
	 *            the channel id to be checked. NOTE: 0, 1, 2, 3 will indicate
	 *            ch1, ch2, ch3, ch4 respectively
	 * @param channelBitmask
	 *            the numeric code of the given channel bitmask
	 * 
	 * @return true if the given channel is enabled (present) in the given
	 *         bitmask; false otherwise
	 */
	...
	/**
	 * Returns the number of of channels that enabled in the given channel
	 * bitmask
	 * 
	 * @param channelBitmask
	 *            the numeric code of the given channel bitmask
