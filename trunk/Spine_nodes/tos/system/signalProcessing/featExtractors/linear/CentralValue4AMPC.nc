 ...
 */
 ...
 module CentralValue4AMPC {

       provides interface CentralValue4AMP;
}
...
implementation {
       ...
       */
       command int32_t CentralValue4AMP.calculate(int16_t* data, uint16_t elemCount) {
            if (elemCount%2 == 0)
                return ( (((int32_t)(*(data + ( elemCount/2 ))))  + ((int32_t)(*(data + ( (elemCount/2)-1 )))))/2 );
            else 
                return (int32_t)(*( data + ( (elemCount-1)/2 )) );
       }
