...
/**
 * This component calculate the cross-axial Total Energy
 *
 ...
 */   
 interface TotalEnergy {
       ...
       /*
       * Calculates the cross-axial current Total Energy of the given data array,
       ...
       */
       command int32_t calculate(int16_t* data, uint16_t elemCount);
